...
fn part2(garden: &[Vec<char>]) -> usize {
    ...
    // to begin filling adjacent tiles are the manhattan distance between them and
    // the centre of (*) (because one can only take one step north, south, east, or west)
    //
    ...
    // nearest point from the centre of base tile
    #[rustfmt::skip]
